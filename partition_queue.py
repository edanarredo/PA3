...
def generate_processes_partition(ARRIVAL_RATE, AVERAGE_SERVICE_TIME, CPU_COUNT):
   ...
   schedule_event_partition(0, clock + exp_dist_gen(ARRIVAL_RATE), our_event_queue)

   for i in range(0, CPU_COUNT):
      ready_queues.append(EventQueue())
...
def schedule_event_partition(event_type, time, queue_head):
